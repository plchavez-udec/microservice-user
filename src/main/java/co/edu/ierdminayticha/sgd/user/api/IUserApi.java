...
public interface IUserApi {
	...
	public ResponseEntity<UserResponseDto> create(@Validated(IRequestCreateValidation.class) 
	...
	@GetMapping(value = "{usuario-id}", 
				produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<UserResponseDto> findById(@PathVariable("usuario-id") Long id);
